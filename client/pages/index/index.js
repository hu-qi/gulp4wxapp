/*<remove trigger="prod">*/
import {test_0_add, test_1_zhihu} from '../../lib/api-mock'
/*</remove>*/

/*<jdists trigger="prod">
import {test_0_add, test_1_zhihu} from '../../lib/api'
</jdists>*/
...
Page({
  ...
  callFunction: function() {
    this.setData({
      statusMsg: '开始调用云函数，函数名：test_0_add'
    })
  ...
  callFunction2: function() {
    this.setData({
      statusMsg: '开始调用云函数，函数名：test_1_zhihu'
    })
